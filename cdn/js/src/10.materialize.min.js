...
window.cash = function () {
    var t = document, e = window, i = Array.prototype, n = i.slice, s = i.filter, o = i.push, a = function () {
    }, r = function (t) {
    ...
    function g(i, n) {
        ...
        var s, o = i, a = 0;
        if (l(i)) o = h.test(i) ? t.getElementById(i.slice(1)) : u.test(i) ? f(i) : p(i, n); else if (r(i)) return m(i), this;
        if (!o) return this;
        if (o.nodeType || o === e) this[0] = o, this.length = 1; else for (s = this.length = o.length; a < s; a++) this[a] = o[a];
        return this
    }
    ...
    var y = _.fn = _.prototype = g.prototype = {cash: !0, length: 0, push: o, splice: i.splice, map: i.map, init: g};
    Object.defineProperty(y, "constructor", {value: _}), _.parseHTML = f, _.noop = a, _.isFunction = r, _.isString = l, _.extend = y.extend = function (t) {
        t = t || {};
        var e = n.call(arguments), i = e.length, s = 1;
        for (1 === e.length && (t = this, s = 0); s < i; s++) if (e[s]) for (var o in e[s]) e[s].hasOwnProperty(o) && (t[o] = e[s][o]);
        return t
    };
    ...
    var I = function () {
        ...
        var t = {}, e = document, i = e.createElement("div"), n = i.style;
        return function (e) {
    ...
    return y.extend({
        position: function () {
            ...
            return {top: t.top + e.pageYOffset - j.clientTop, left: t.left + e.pageXOffset - j.clientLeft}
...
var Component = function () {
    ...
    return _createClass(t, null, [{
        key: "init", value: function (t, e, i) {
            var n = null;
            if (e instanceof Element) n = new t(e, i); else if (e.jquery || e instanceof NodeList) {
...
document.addEventListener("keydown", docHandleKeydown), document.addEventListener("keyup", docHandleKeyup), M.initializeJqueryWrapper = function (t, e, i) {
    ...
    var s = {
            ...
            spaceOnBottom: null,
            spaceOnLeft: null
        }, o = "visible" === getComputedStyle(e).overflow, a = e.getBoundingClientRect(), r = t.getBoundingClientRect(),
        l = e.scrollLeft, h = e.scrollTop, d = i.left - l, u = i.top - h;
...
M.anime = function () {
    ...
    function m(t) {
        ...
        switch (t.tagName.toLowerCase()) {
            ...
            case"line":
                return v({x: t.getAttribute("x1"), y: t.getAttribute("y1")}, {
                    x: t.getAttribute("x2"),
                    y: t.getAttribute("y2")
                });
            case"polyline":
    ...
    function _(t, e) {
        var i, n = /-?\d*\.?\d+/g;
        if (i = O.pth(t) ? t.totalLength : t, O.col(i)) if (O.rgb(i)) {
            ...
            if (0 == n) s = n = t = s; else {
                var o = .5 > s ? s * (1 + n) : s + n - s * n, a = 2 * s - o, s = e(a, o, t + 1 / 3), n = e(a, o, t);
                t = e(a, o, t - 1 / 3)
            }
    ...
    function k(t, e) {
        ...
        if (O.arr(t)) {
            var s = t.length;
            2 !== s || O.obj(t[0]) ? O.fnc(e.duration) || (i.duration = e.duration / s) : t = {value: t}
        }
    ...
    function b(t, e) {
        ...
        return t.tweens.map(function (n) {
            var s = (n = function (t, e) {
                ...
                }(n, e)).value, o = c(e.target, t.name), a = i ? i.to.original : o, a = O.arr(s) ? s[0] : a,
                r = p(O.arr(s) ? s[1] : s, a), o = l(r) || l(a) || l(o);
    ...
    function C(t) {
        ...
        for (n in t) d.hasOwnProperty(n) || "targets" === n || h.push({name: n, offset: d.offset, tweens: k(t[n], o)});
    ...
    function E(t) {
        ...
        function s(t) {
            for (var i = 0, n = {}, s = v.animations, o = s.length; i < o;) {
                var a = s[i], r = a.animatable, l = a.tweens, h = l.length - 1, u = l[h];
                h && (u = e(l, function (e) {
                    return t < e.end
                })[0] || u);
                for (var l = Math.min(Math.max(t - u.start - u.delay, 0), u.duration) / u.duration, c = isNaN(l) ? 1 : u.easing(l, u.elasticity), l = u.to.strings, p = u.round, h = [], f = void 0, f = u.to.numbers.length, m = 0; m < f; m++) {
                    var _ = void 0, _ = u.to.numbers[m], y = u.from.numbers[m],
                        _ = u.isPath ? g(u.value, c * _) : y + c * (_ - y);
                    p && (u.isColor && 2 < m || (_ = Math.round(_ * p) / p)), h.push(_)
                }
                if (u = l.length) for (f = l[0], c = 0; c < u; c++) p = l[c + 1], m = h[c], isNaN(m) || (f = p ? f + (m + p) : f + (m + " ")); else f = h[0];
                B[a.type](r.target, a.property, f, n, r.id), a.currentValue = f, i++
            }
            if (i = Object.keys(n).length) for (s = 0; s < i; s++) M || (M = d(document.body, "transform") ? "transform" : "-webkit-transform"), v.animatables[s].target.style[M] = n[s].join(" ");
    ...
    return E.version = "2.2.0", E.speed = 1, E.running = I, E.remove = function (t) {
        t = y(t);
        for (var e = I.length; e--;) for (var i = I[e], n = i.animations, o = n.length; o--;) s(t, n[o].animatable.target) && (n.splice(o, 1), n.length || i.pause())
    }, E.getValue = c, E.path = function (e, i) {
        var n = O.str(e) ? t(e)[0] : e, s = i || 100;
        return function (t) {
        ...
        return _createClass(s, [{
            ...
            key: "_handleDropdownKeydown", value: function (e) {
                ...
                if (o && -1 === [9, 13, 27, 38, 40].indexOf(e.which)) {
                    ...
                    var a = this.filterQuery.join(""), r = t(this.dropdownEl).find("li").filter(function (e) {
            ...
            key: "_getDropdownPosition", value: function () {
                ...
                var t = {
                    ...
                    i = this.dropdownEl.getBoundingClientRect(), n = i.height, s = i.width, o = t.left, a = t.top,
                    r = {left: o, top: a, height: n, width: s}, l = this.dropdownEl.offsetParent,
                    h = M.checkPossibleAlignments(this.el, l, r, this.options.coverTrigger ? 0 : e.height), d = "top",
    ...
    var i = {
        ...
        return _createClass(s, [{
            ...
            key: "open", value: function () {
                ...
                }), this.$overlay = t('<div id="materialbox-overlay"></div>').css({opacity: 0}).one("click", function () {
                ...
                this.$overlay.css({
                    ...
                    duration: this.options.inDuration,
                    easing: "easeOutQuad"
                }), "" !== this.caption && (this.$photoCaption = t('<div class="materialbox-caption"></div>'), this.$photoCaption.text(this.caption), t("body").append(this.$photoCaption), this.$photoCaption.css({display: "inline"}), e({
    ...
    var i = {
        ...
        return _createClass(s, [{
            ...
            key: "_positionTooltip", value: function () {
                var e = this.$el[0], i = this.tooltipEl, n = e.offsetHeight, s = e.offsetWidth, o = i.offsetHeight,
            ...
            key: "_getAttributeOptions", value: function () {
                var t = {}, e = this.$el[0].getAttribute("data-tooltip"), i = this.$el[0].getAttribute("data-position");
    ...
    var s = {
        duration: 750, show: function (t, e) {
            ...
            }(i), r = t.pageY - a.top, l = t.pageX - a.left, h = "scale(" + i.clientWidth / 100 * 10 + ")";
            ...
            var r = (i = a[a.length - 1]).getAttribute("data-x"), l = i.getAttribute("data-y"),
                h = i.getAttribute("data-scale"), d = 350 - (Date.now() - Number(i.getAttribute("data-hold")));
    ...
    var e = {
        ...
        return _createClass(n, [{
            ...
            key: "_removeAutocomplete", value: function () {
        ...
        return _createClass(n, [{
            ...
            key: "draw", value: function (t) {
                if (this.isOpen || t) {
                    ...
                    M.Select.init(h, {classes: "select-year"}), M.Select.init(d, {classes: "select-month"}), h.addEventListener("change", this._handleYearChange.bind(this)), d.addEventListener("change", this._handleMonthChange.bind(this)), "function" == typeof this.options.onDraw && this.options.onDraw(this)
                }
            }
        }, {
            key: "_setupEventHandlers", value: function () {
            ...
            key: "_handleTodayClick", value: function () {
        ...
        return _createClass(n, [{
            ...
            key: "_scroll", value: function (e) {
                ...
                if (this.offset = "number" == typeof e ? e : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), r = -(a = (o = this.offset - this.center * this.dim) < 0 ? 1 : -1) * o * 2 / this.dim, s = this.count >> 1, this.options.fullWidth ? h = "translateX(0)" : (h = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", h += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)"), this.showIndicators) {
                    var p = this.center % this.count, v = this.$indicators.find(".indicator-item.active");
        ...
        return _createClass(n, [{
            ...
            key: "_calculatePositioning", value: function () {
                ...
                var s = this.$origin.outerWidth(), o = this.$origin.outerHeight(),
                    ...
                    x = c && !m ? g / 2 - s : 0, L = s, T = f ? "bottom" : "top", O = 2 * s, $ = O, D = _ / 2 - $ / 2,
                    B = g / 2 - O / 2, I = {};
                I.top = v ? y + "px" : "", I.right = p ? l - k - g + "px" : "", I.bottom = f ? h - y - _ + "px" : "", I.left = c ? k + "px" : "", I.position = b, t(this.wrapper).css(I), t(this.contentEl).css({
                    ...
                    padding: L + "px",
                    verticalAlign: T
                }), t(this.waveEl).css({top: D + "px", left: B + "px", width: O + "px", height: $ + "px"})
            }
        }, {
            key: "open", value: function () {
